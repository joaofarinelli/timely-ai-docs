...
```json
{
  ...
  "data": {
    ...
    "messages_used": 1834,
    "contacts_total": 87,
    "upgrade_url": "https://app.rovax.io/billing/upgrade"
  }
}
```
...
<Tip>
  Se você é um parceiro ou revendedor da Rovax.io e gerencia múltiplos workspaces, use `trial.expiring` e `trial.expired` para automatizar follow-ups de conversão. Os campos `conversations_used` e `messages_used` mostram o engajamento do cliente durante o trial — ótimos dados para personalizar a abordagem.
</Tip>
