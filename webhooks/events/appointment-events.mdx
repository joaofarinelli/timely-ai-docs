...
Esses eventos cobrem o ciclo de vida dos agendamentos gerenciados pela Rovax.io — seja via agente de IA integrando com Google Calendar, seja via fluxo manual do atendente. Use-os para sincronizar com sistemas de gestão de clínicas, academias, salões ou qualquer negócio com agenda.
