...
This cookbook is a collection of **practical recipes** for building real agents on Timely.ai — so you don't have to figure everything out from scratch. Each recipe starts from a concrete problem and ends with an agent running on your client's channel.
