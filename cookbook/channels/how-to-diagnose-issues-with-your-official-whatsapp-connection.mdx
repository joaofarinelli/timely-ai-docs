...
It's important to show you how to easily identify when there is a problem with the Official WhatsApp connection with Rovax.io.

Whenever Rovax.io receives an authentication error or any other error from Meta that affects the connection, the platform **automatically disables it**.
...
For more details about WhatsApp Official connection and values, access: https://docs.rovax.io/channels/channel-types/whatsapp-official
