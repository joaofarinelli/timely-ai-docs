...
description: "In Timely.ai, an **Agent** is more than a chatbot. <br />
...
Agents can be extended using native Timely.ai resources:
...
Native Timely.ai databases used for structured data like:
...
2. **Native data handling** — Knowledge Bases and Tables live inside Timely
...
👉 In Timely.ai, an Agent is not just answering questions — it’s a **scalable digital teammate** that evolves with your business.