...
description: "In Rovax.io, each Agent can be powered by a specific **Provider** and **Model**. <br />
...
<h3 style={{ marginTop: '1rem' }}>Option 1 — Using Rovax.io Provider</h3>

When you select **Rovax.io** as the provider, your Agent uses models natively available on the platform (such as *Claude Sonnet* 4.6 or *GPT-5.4*).

In this mode:

- You've used up your **Rovax.io internal usage quota** per execution.
- Authentication and billing are fully managed by Rovax.io
...
You can also connect your **own LLM provider**, bypassing Rovax.io internal usage quota.
...
- Rovax.io does not charge credits for model execution
...
- Use **Rovax.io Provider** for faster setup and predictable billing
