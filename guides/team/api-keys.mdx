---
title: API Keys
description: Crie, configure escopos, rotacione e revogue chaves de API para integrar sistemas externos à Rovax.io.
---

As API Keys da Rovax.io permitem que sistemas externos acessem os recursos da plataforma de forma programática — sem precisar de credenciais de usuário. Use chaves de API para integrar seu CRM, sistemas internos ou pipelines de automação.
