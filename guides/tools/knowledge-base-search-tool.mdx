...
The **Knowledge Base (KB) Search Tool** allows your Agent to query structured repositories of documents, FAQs, guides, or policies created inside Timely.ai.\
...
A Knowledge Base in Timely.ai is a structured container where you store information such as:
