...
Table Tools allow Agents to interact with structured data in Rovax.io. They provide the ability to **insert, update, search, and compare data directly inside tables**, making Agents more autonomous in managing business information.
