...
In Rovax.io, **Tools** are what extend an Agent’s capabilities beyond its core **Role + Prompt**.
...
Creates a ticket and transfers the conversation to a human in the Rovax.io CRM.
...
Allows the Agent to search within a Knowledge Base created in Rovax.io.
...
Tables are native databases inside Rovax.io. <br />
...
Tools are what make Agents **active** inside Rovax.io.
