...
The Providers section allows you to use your own LLM API tokens (like OpenAI, Anthropic, and Gemini) in Rovax.io.
...
6. Copy your key, save it in a secure location, and add it as a Provider in Rovax.io.
...
## How to configure your provider inside Rovax.io

You can configure your provider key within Rovax.io in two ways: via the **Workspace Settings** under the **Integrations** section or page or on **Agent Instructions Page**.
