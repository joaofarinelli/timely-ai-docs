...
Each workspace in Rovax.io has its own usage dashboard, displaying two main types of information:
...
Custom Providers allow you to connect an Agent to your own LLM API key — such as OpenAI, Anthropic, Google Gemini, or others — instead of using Rovax's default model.
...
⚠️ **Disclaimer:** This page explains how usage tracking works in Rovax. For current plan limits and details, always refer to the **Plans page inside the platform**.
