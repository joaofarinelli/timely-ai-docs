...
Criar uma base de conhecimento não é suficiente para que o agente a utilize — é necessário conectar explicitamente a base ao agente. Essa conexão é feita na seção **Bases de conhecimento** do agente e ativa o pipeline de retrieval para todas as conversas atendidas por ele.
...
<Steps>
  ...
  <Step title="Acesse as bases de conhecimento">
    Dentro da tela do agente, abra a seção **Bases de conhecimento**. É nela que você conecta as fontes indexadas ao agente.
  </Step>
