...
O Website Crawler permite que você adicione o conteúdo do seu site à Knowledge Base sem precisar copiar e colar manualmente. Basta informar a URL e configurar a profundidade de rastreamento. A Rovax.io usa o [Firecrawl](https://www.firecrawl.dev) para extrair o conteúdo de cada página e depois processa os embeddings automaticamente.
...
<Tip>
  Reindexe o site sempre que o conteúdo mudar significativamente. Delete o site da lista e adicione novamente para garantir que o agente use a versão mais atualizada — a Rovax.io não realiza re-crawl automático por enquanto.
</Tip>
