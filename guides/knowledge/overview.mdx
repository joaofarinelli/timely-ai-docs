...
<Steps>
  ...
  <Step title="Conexão ao agente">
    A base é conectada a um ou mais agentes na seção **Bases de conhecimento**. Os parâmetros de retrieval — top-k e threshold de similaridade — são configurados por base.
  </Step>
