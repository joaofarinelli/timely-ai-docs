...
<body>
  <script>
    window.ZV2Widget = {
      ChannelURL: "https://widget.rovax.io/widget/channel/..."
    };
  </script>
  <script src="https://widget.rovax.io/script/widget-loader.js" async></script>
</body>
```
...
For **Widget Channels**, Rovax.io provides a live customization environment:
