...
<Steps>
  <Step title="Create your account">
    Go to [app.rovax.io](https://app.rovax.io) and click **Create account**. Fill in your name, email, and password.
  ...
  <Step title="Train the agent with a document">
    ...
    - Website URL (Rovax indexes the content automatically)
  ...
  <Step title="Connect a channel">
    ...
    <script>
      window.RovaxConfig = { widgetId: "YOUR_WIDGET_ID" };
    </script>
    <script src="https://cdn.rovax.io/widget.js" defer></script>
    ```
