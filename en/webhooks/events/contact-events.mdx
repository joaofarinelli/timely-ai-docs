...
These events keep your external database or CRM in sync with Rovax.io's contact base. Every time a new contact comes in, a field is updated, or a contact is deleted, you receive an event.
