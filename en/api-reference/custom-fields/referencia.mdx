...
**Custom Fields** let you add extra fields to contact profiles in the Rovax.io CRM, beyond the default fields like name, email, and phone. They are useful when you need to store business-specific information — order number, subscribed plan, customer segment, last purchase date, tax ID, company name, and so on.
