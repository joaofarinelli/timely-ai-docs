---
title: "Introduction"
description: "Rovax.io REST API for AI-powered customer service automation."
---

<Note>
  This documentation is intended for developers who want to integrate their systems with Rovax.io.
  For information on using the platform, see the [Guides](/en/index).
</Note>

## Overview

The Rovax.io API lets you programmatically manage all platform resources:
...
To obtain your API key, visit the [developers page](https://app.rovax.io/developers).
