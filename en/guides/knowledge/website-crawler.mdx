...
The Website Crawler lets you add your website content to the Knowledge Base without copying and pasting manually. Simply provide the URL and configure the crawl depth. Rovax.io uses [Firecrawl](https://www.firecrawl.dev) to extract the content of each page and then processes the embeddings automatically.
...
<Tip>
  Re-index the site whenever content changes significantly. Delete the site from the list and add it again to ensure the agent uses the most up-to-date version — Rovax.io does not perform automatic re-crawling at this time.
</Tip>
