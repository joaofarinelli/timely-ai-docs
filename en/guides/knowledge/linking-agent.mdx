...
Creating a Knowledge Base is not enough for the agent to use it — you must explicitly connect the base to the agent. This connection is made in the agent's **Knowledge bases** section and activates the retrieval pipeline for all conversations handled by that agent.
...
<Steps>
  ...
  <Step title="Open Knowledge bases">
    Inside the agent screen, open the **Knowledge bases** section. This is where you connect indexed sources to the agent.
  </Step>
