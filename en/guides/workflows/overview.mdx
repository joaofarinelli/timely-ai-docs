...
Workflows are sequences of connected nodes that execute automations in Rovax.io. Every flow starts with a trigger, moves through action and logic nodes you configure, and can return structured data to the caller when needed.
