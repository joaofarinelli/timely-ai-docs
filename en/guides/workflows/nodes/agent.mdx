...
description: "Expose a workflow as a tool for Rovax.io AI agents."
---
...
The **Agent Request** trigger turns a workflow into a tool that AI agents configured in Rovax can trigger during a conversation. When the agent identifies that it needs to execute the workflow, it assembles the parameters defined in the node and fires the call.
