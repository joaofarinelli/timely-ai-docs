...
<Steps>
  ...
  <Step title="Copy the snippet">
    Rovax.io generates the code with the `data-agent-id` of your integration. Paste it before the `</body>` tag on all pages where the chat should appear.
  </Step>
...
```html
<script src="https://widget.rovax.io/embed.js"
