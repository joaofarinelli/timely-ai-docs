...
description: "General flow for creating and activating any channel type in Rovax.io — configuration parameters, management, and troubleshooting."
---
...
| Channel disconnects automatically | Short-lived token expired (common with Instagram and WhatsApp WABA) | Generate a long-lived token in the platform manager and update the credentials in Rovax.io |
