---
title: "Internal Chat"
description: "How to use Rovax.io's internal chat to test the agent directly on the platform, inspect executions, and validate behavior before publishing."
---

The internal chat is the agent's native testing interface within Rovax.io. It allows you — and any team member with access — to converse with the agent directly on the platform, without needing to publish to any external channel like WhatsApp, Instagram, or a website widget.
