---
title: "Temperature"
description: "How the temperature parameter affects the variability of agent responses, recommended ranges by use case, and how to configure the slider in Rovax.io."
---
...
Rovax.io uses range labels to make slider selection easier (0.05 increments). OpenAI GPT-5.x models disable the slider automatically; Anthropic models with active reasoning force temperature 1.0 via the API.
