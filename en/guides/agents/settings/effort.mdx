...
description: "How the effort parameter controls the depth of the agent's reasoning in Rovax.io, its impact on cost and latency, and when to use each level."
---

Effort defines how many reasoning steps the agent can use to formulate a response. In Rovax.io, it is controlled by a slider from 10 to 100 steps (5-step increments), divided into four labeled levels:
