...
description: "How to use conditional prompts in Rovax.io to adapt agent behavior by customer segment, channel, or funnel stage without creating multiple agents."
---
