---
title: "Creating with Orion AI"
description: "How to use Rovax.io's guided flow to create an agent via conversation: the assistant asks the right questions and generates the prompt automatically."
---

Rovax.io's conversational assistant walks you through a structured dialog that collects everything needed to build a complete agent. You answer questions in natural language and the assistant configures the agent — including the system prompt — automatically at the end of the process.
