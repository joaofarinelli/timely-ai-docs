...
<Tip>
  Keep the Squad ID in a safe place if you plan to use the Rovax.io API to create or update channel links programmatically. The ID does not change even if the squad's name is changed.
</Tip>
