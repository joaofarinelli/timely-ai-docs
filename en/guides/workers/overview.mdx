...
Workers is the Rovax.io space where you converse directly with an agent or squad as if they were an internal collaborator. While the customer service chat is designed for sessions aimed at the end consumer, Workers is for you — the operator — to delegate work that the agent will process autonomously.
...
|---|---|---|
| Executor | Agent or squad from your account | Rovax.io built-in copilot |
