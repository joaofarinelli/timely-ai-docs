---
title: API Keys
description: Create, configure scopes, rotate, and revoke API keys to integrate external systems with Rovax.io.
---

Rovax.io API Keys allow external systems to access platform resources programmatically — without requiring user credentials. Use API keys to integrate your CRM, internal systems, or automation pipelines.
