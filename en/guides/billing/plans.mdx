...
<Steps>
  ...
  <Step title="Enter card details">
    A secure form is displayed. Enter the card number, expiration date, CVV, and cardholder name. Data is transmitted directly to the payment processor — Rovax.io does not store card data on its servers.
  </Step>
