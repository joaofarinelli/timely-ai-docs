---
title: "Introdução"
description: "API REST do Rovax.io para automação de atendimento com IA."
---

<Note>
  Esta documentação é destinada a desenvolvedores que desejam integrar seus sistemas com o Rovax.io.
  Para informações sobre o uso da plataforma, consulte os [Guias](/index).
</Note>

## Visão geral

A API do Rovax.io permite gerenciar programaticamente todos os recursos da plataforma:
...
curl -H "x-api-key: sua_chave_aqui" \
  https://api.rovax.io/v1/me
```

Para obter sua chave de API, acesse a [página de desenvolvedores](https://app.rovax.io/developers).
